...
Разместите файл `settings.json` в тот же каталог, где расположен Чат.
...
### 8. Скачайте файл [web-notification-sw.js](https://github.com/ThreadsMobileLib/threads-sdk-web-gate/tree/master/examples/Standard/web-notification-sw.js)
