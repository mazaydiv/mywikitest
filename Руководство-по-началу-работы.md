#### Содержание
* [1. Получите у аккаунт-менеджера реквизиты для подключения библиотеки для следующих параметров:](#1-получите-у-аккаунт-менеджера-реквизиты-для-подключения-библиотеки-для-следующих-параметров:)
* [2. Скачайте актуальную версию виджета для настройки чата](#2-скачайте-актуальную-версию-виджета-для-настройки-чата)
* [3. Разместите файлы виджета `***.min.js`, `***.min.css` в корне или каком-либо каталоге своего сайта](#3-разместите-файлы-виджета-minjs-mincss-в-корне-или-каком-либо-каталоге-своего-сайта)
* [4. Скачайте пример конфигурационного файла [`settings.json`](https://github.com/ThreadsMobileLib/threads-sdk-web-gate/blob/master/examples/Standard/settings.json)](#4-скачайте-пример-конфигурационного-файла-[settingsjson]https:githubcomthreadsmobilelibthreads-sdk-web-gateblobmasterexamplesstandardsettingsjson)
* [5. Настройте в файле `settings.json` параметры, данные которых были получены от аккаунт-менеджера на шаге 1.](#5-настройте-в-файле-settingsjson-параметры-данные-которых-были-получены-от-аккаунт-менеджера-на-шаге-1)
* [6. Настройте цветовую схему, подходящую вашему сайту.](#6-настройте-цветовую-схему-подходящую-вашему-сайту)
* [7. Настройте WebPush уведомления:](#7-настройте-webpush-уведомления:)
* [8. Скачайте файл [web-notification-sw.js](../demo/WebPush/web-notification-sw.js)](#8-скачайте-файл-[web-notification-swjs]demowebpushweb-notification-swjs)
* [9. Встройте виджет на сайт:](#9-встройте-виджет-на-сайт:)
* [10. Откройте страницу на своем сайте](#10-откройте-страницу-на-своем-сайте)
* [11. В случае корректной настройки в нижнем правом углу браузера появится кнопка для открытия чата. При нажатии на нее загрузится стартовое окно чата.](#11-в-случае-корректной-настройки-в-нижнем-правом-углу-браузера-появится-кнопка-для-открытия-чата-при-нажатии-на-нее-загрузится-стартовое-окно-чата)
